# Generated by Powerlevel10k configuration wizard on 2025-08-13 at 20:59 PDT.
...
# 2 lines, disconnected, right frame, white-ornaments, compact, few icons, concise,
...
() {
  ...
  # Emit OSC 133 marks so terminals (e.g. WezTerm copy mode) can jump between
  # shell prompts/command outputs as semantic zones.
