...
# Ubuntu/Debian init script for dotfiles (Server/Headless)
# Excludes GUI applications (wezterm, neovide)
# For full Ubuntu with GUI apps, use init-ubuntu.sh
# For macOS, use init-macos.sh
...
echo -e "\033[34m🐧 Starting Ubuntu dotfiles installation (server/headless)...\033[0m"
...
echo "   (Server/Headless configuration)"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "Next steps:"
...
echo ""
echo "Notes:"
echo "  • This is the server/headless version (no GUI apps)"
echo "  • For GUI apps (WezTerm, Neovide), use init-ubuntu.sh"
